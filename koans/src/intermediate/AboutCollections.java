...
//        System.out.println(queue.poll());
    ...
    public void usingABasicMap() {
        ...
        map.put("first key", "other value"); //----Replaced the 1st one with the other value!!!
        assertEquals(map.size(), 2);
        assertEquals(map.containsKey("first key"), true);
        assertEquals(map.containsKey("second key"), true);
        assertEquals(map.containsValue("first value"), false); //Coz the 1st value was replaced with or by otherValue Set SHit!!!
