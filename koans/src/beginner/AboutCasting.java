...
public class AboutCasting {
    ...
    public void longPlusInt() {
        ...
        long b = 10;
        Object c = a + b;
        assertEquals(c, 16L);  //-*-*- OR -_*_-*_- (long)16 -*-*-
    ...
    public void forceIntTypecast() {
        ...
        //Q:Why will it be a negative number?
    }
    ...
    public void implicitTypecast() {
        ...
        long c = a + b;
        // still overflows int...
        // which is the Integer.MIN_VALUE,
        // the operation occurs prior to assignment to long
...
// -*-*- THE FATHER HAS DOWNCASTED TO THE CHILD -*-*-*-
